...
export default function Navbar(props) {
  return (
    <nav className="navbar navbar-expand-lg bg-info" style={{width:"100%", padding:"0px", margin:"0px"}}>
  ...
  <div className="container-fluid" >
	...
	<button className="btn btn-outline-success" type="login" style={{marginLeft:"5%"}}>Login/Signin</button>
    </div>
  </div>
</nav>
  )
